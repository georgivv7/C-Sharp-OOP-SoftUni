namespace Forum.App.Menus
{
    ...
    public class AddReplyMenu : Menu, ITextAreaMenu, IIdHoldingMenu
    {
        ...
        public AddReplyMenu(ILabelFactory labelFactory, ITextAreaFactory textAreaFactory,
			ICommandFactory commandFactory, IForumReader reader, IPostService postService)
        {
        ...
        public override IMenu ExecuteCommand()
		{
			if (this.CurrentOption.IsField)
			{
				...
				this.Buttons[currentIndex] = this.labelFactory.CreateButton(fieldInput, this.CurrentOption.Position,
					false, true);
				return this;
			}
			else
