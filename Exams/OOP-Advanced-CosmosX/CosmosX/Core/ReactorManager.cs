namespace CosmosX.Core
{
    ...
    public class ReactorManager : IManager
    {
        ...
        public string ReactorCommand(IList<string> arguments)
        {
            ...
            IReactor reactor = this.reactorFactory.CreateReactor(reactorType, this.currentId, 
                container, additionalParameter);
        ...
        public string ModuleCommand(IList<string> arguments)
        {
            ...
            {
                case "CryogenRod":
                    CryogenRod cryogenRod = new CryogenRod(this.currentId, additionalParameter);
                    ...
                    break;
                case "HeatProcessor":
                    HeatProcessor heatProcessor = new HeatProcessor(this.currentId, additionalParameter);
                    ...
                    break;
                case "CooldownSystem":
                    CooldownSystem cooldownSystem = new CooldownSystem(this.currentId, additionalParameter);
        ...
        public string ReportCommand(IList<string> arguments)
        {
            ...
            string result = this.reactors.ContainsKey(id) ?
                this.reactors[id].ToString() :
                this.modules[id].ToString();
        ...
        public string ExitCommand(IList<string> arguments)
        {
            ...
            long energyModulesCount = this.modules
                .Values
                .Count(m => m.GetType().Name.StartsWith("Cryo"));

            long absorbingModulesCount = this.modules
                .Values
                .Count(m => m.GetType().Name.StartsWith("Cryo") == false);
