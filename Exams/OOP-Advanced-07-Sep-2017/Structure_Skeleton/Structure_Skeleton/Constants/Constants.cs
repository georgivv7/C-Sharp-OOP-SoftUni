public static class Constants
{
    ...
    public const string BrokenEntity = "{0} with ID: {1} is broken!"; 

    public const string InvalidEntityID = "No entity found with id - {0}"; 

    public const string TotalEnergy = "Total Energy Produced: {0}";
    
    public const string TotalMinedOre = "Total Mined Plumbus Ore: {0}"; 
    
    public const int DurabilityDecrease = 100;      
}