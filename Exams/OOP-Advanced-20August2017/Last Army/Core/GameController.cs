...
public class GameController
{
    ...
    public void RequestResult()
    {
        ...
        writer.AppendLine
            (string.Format(OutputMessages.SuccessfulMissionsCount,missionController.SuccessMissionCounter));
        writer.AppendLine
            (string.Format(OutputMessages.FailedlMissionsCount, missionController.FailedMissionCounter));
        writer.AppendLine(OutputMessages.Soldiers);
        foreach (var soldier in this.army.Soldiers.OrderByDescending(os=>os.OverallSkill))
        {
