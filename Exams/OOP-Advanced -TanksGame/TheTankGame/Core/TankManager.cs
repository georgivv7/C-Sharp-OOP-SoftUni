namespace TheTankGame.Core
{
    ...
    public class TankManager : IManager
    {
        ...
        public string AddVehicle(IList<string> arguments)
        {
            ...
            IVehicle vehicle = this.vehicleFactory.CreateVehicle(vehicleType, model, weight, 
                price, attack, defense, hitPoints);
        ...
        public string AddPart(IList<string> arguments)
        {
            ...
            IPart part = this.partFactory.CreatePart(partType,model, weight, 
        ...
        public string Battle(IList<string> arguments)
        {
            ...
            string winnerVehicleModel = this.battleOperator.Battle(this.vehicles[attackerVehicleModel], 
