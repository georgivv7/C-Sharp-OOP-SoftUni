namespace TheTankGame.Core
{
    ...
    public class CommandInterpreter : ICommandInterpreter
    {
        ...
        public string ProcessInput(IList<string> inputParameters)
        {
            ...
            var function = this.tankManager.GetType()
                .GetMethods().FirstOrDefault(x => x.Name == command);

            result = (string)function.Invoke(this.tankManager, new object[] { inputParameters });
